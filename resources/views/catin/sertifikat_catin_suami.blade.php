    ...
    <div class="card">
      <div class="card-body">
        <p class="card-title">Sertifikat Calon Suami</p>
            ...
            @else
         <a href="{{route('catin_cetak_sertifikat_suami')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-download fa-sm text-white-50"></i> Download PDF</a>
          ...
          <div class="col-12">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                MUSTAIN HAKIM, S.Ag, M.HI<br>
                NIP. 197501252000031001<br>
              </div>
              <div class="col-md-1"></div>
