      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <h2 style="text-align: center; text-decoration: underline;">{{$data->nama_calon_suami}}</h2>
            <br>
            ...
            <a style="margin-left: 24%; position: relative"> : {{$data->alamat_calon_suami}}</a><br><br>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <img src="{{asset('uploads/foto_calon_suami/'.$data->foto_calon_suami)}}" style="width: 120px; height: auto; margin-left: 30%; position: absolute;">
